	...
	\begin{center}
		\begin{tabular}{|p{1.5cm}|p{1.5cm}|c|}
			...
			& Segmented &
				...
				\end{tabular} \\  								
			\hline
			\multirow{4}*{Random Background Images}
			& Original & 
					\begin{tabular}{@{}c@{}}
					$\textbf{Average Accuracy = 0.932301}$ \\
					$\textbf{Precision_M = 0.925955}$ \\
					$\textbf{Recall_M = 0.913326}$ \\
					$\textbf{F_1 score_M = 0.916384}$ \\
					\end{tabular} \\
			\cline{2-3}
			& Segmented &
				\begin{tabular}{@{}c@{}}
				$\textbf{Average Accuracy = 0.390169}$ \\
				$\textbf{Precision_M = NaN}$ \\
				$\textbf{Recall_M = 0.285877}$ \\
				$\textbf{F_1 score_M = Nan}$ \\
				\end{tabular} \\  				
			\hline
		\end{tabular}
	\end{center}
